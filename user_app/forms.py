...
class ClientRegistrationForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)        
        self.fields['username'].widget.attrs.update({'class' : 'input100', 'placeholder' : 'Enter your Username'})
        self.fields['password'].widget.attrs.update({'class' : 'input100', 'placeholder' : 'Enter your Password'})
...
class ProfileUpdateForm(forms.ModelForm):
    ...
    class Meta:
        model = Profile
        fields = ['first_name', 'last_name', 'profile_pic','age', 'gender', 'seeking', 'about', 'state', 'city', 'relationshipStatus', 'kidsStatus', 'hobbyList', 'profession', 'partnerPreference', 'complexion', 'seekingRelationship', 'country']
